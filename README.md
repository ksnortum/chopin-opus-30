...
[LilyPond](https://lilypond.org/) engraving source files used to create Chopin's Four Mazurkas, Opus 30.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond mazurkas-op30-book.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click mazurkas-op30-book.ly

You may also [download the latest release](https://github.com/ksnortum/chopin-opus-30/releases/latest) to get the compiled PDF and MIDI files.
